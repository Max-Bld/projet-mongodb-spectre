...
*Projet Spectre GUI* est écrit en _Python_ et émet des requêtes _MongoDB_ à une base de données _NoSQL_. Les graphiques sont générés à l'aide de la bibliothèque _matplotlib_.
